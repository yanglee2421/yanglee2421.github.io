...
export function AutoComplete() {
  ...
  const changeHandler: Props["onChange"] = (evt, v) => {
    void evt;
    setModel(v);
  };

  const inputChgHandler: Props["onInputChange"] = (evt, v) => {
    void evt;
    setInputModel(v);
  };
...
type Props = AutocompleteProps<Option, false, false, false>;
interface Option {
  label: string;
  year: number;
}
