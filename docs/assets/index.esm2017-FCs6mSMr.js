import{B as _e,C as ge,D as z,S as me,E as L,F as Re,G as we,H as be,I as Te,J as ye}from"./index-NOl4DqEL.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fe="storage";function Lt(e,t,n){return e=L(e),kt(e,t,n)}function vt(e){return e=L(e),Et(e)}function St(e,t){return e=L(e),It(e,t)}function Bt(e=be(),t){e=L(e);const s=Re(e,fe).getImmediate({identifier:t}),r=we("storage");return r&&Pt(s,...r),s}function Pt(e,t,n,s={}){Nt(e,t,n,s)}function Dt(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new q(n,s,r,t,me)}function Ct(){_e(new ge(fe,Dt,"PUBLIC").setMultipleInstances(!0)),z(G,Y,""),z(G,Y,"esm2017")}Ct();export{vt as a,Bt as g,St as r,Lt as u};
