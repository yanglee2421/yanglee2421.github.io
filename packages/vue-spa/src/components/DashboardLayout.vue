...
<template>
  ...
  >
    ...
    <main class="box-border flex min-h-dvh flex-col pbs-12 md:ps-64">
      <div class="grow p-(--spacingHorizontalL)">
        <slot></slot>
      </div>
      <footer class="p-3 text-center">
        &copy; 2024 by yanglee2421.github.io. All rights reserved.
      </footer>
    </main>
  </div>
</template>
